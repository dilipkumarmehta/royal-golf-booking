...
@XmlSeeAlso({
    org.opentravel.ota.beans.IndCoverageReqsType.PreexistingConditions.PreexistingCondition.class,
    org.opentravel.ota.beans.PTCFareBreakdownType.Endorsements.Endorsement.class,
    CertificationType.class,
    ErrorType.class,
    WarningType.class,
    org.opentravel.ota.beans.TicketingInfoType.TicketAdvisory.class,
